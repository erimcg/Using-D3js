...
html: $(foreach CHAP,$(CHAPTERS),html/$(CHAP).html) html/js/acorn_codemirror.js html/js/chapter_info.js

html/%.html: %.md
	node src/render_html.js $< > $@
	node src/build_code.js $<
	cp node_modules/codemirror/lib/codemirror.css html/css/codemirror.css
...
html/js/chapter_info.js: $(foreach CHAP,$(CHAPTERS),$(CHAP).md) $(shell find code/solutions -type f) src/chapter_info.js
